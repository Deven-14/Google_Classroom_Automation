...
//const TOKEN_PATH = "E:\\Projects\\Srini_Sir\\Classroom_Automation\\data_collector\\token.json";
...
module.exports = function() {
    ...
    return new Promise((resolve, reject) => {
        fs.readFile("../data_collector/credentials.json", (err, content) => {  //************ CHANGED FROM credentials.json to full path coz error in frontend/index.js (relative path error)
